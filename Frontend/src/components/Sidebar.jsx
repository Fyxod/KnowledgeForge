      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-3">
        {threads.length === 0 ? (
          ...
          threads
            .sort((a, b) => {
              const dateA =
                a.updatedAt || a.createdAt || a.created_at || new Date(0);
              const dateB =
                b.updatedAt || b.createdAt || b.created_at || new Date(0);
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-blue-300 transition-colors p-1 rounded-full hover:bg-black/20"
                      title="Rename thread"
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M15.232 5.232l3.536 3.536M16.732 3.732a2.5 2.5 0 013.536 3.536L7.5 20.036H4v-3.536L16.732 3.732z"
                        />
                      </svg>
                    </button>
