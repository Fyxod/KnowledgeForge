          ...
          <div className="flex items-center gap-4">
            ...
            {thread.documents && thread.documents.length > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-200 shadow-md hover:shadow-lg"
