 ...
 * Sidebar Component
 * 
 * Provides navigation and thread management functionality.
 * Displays user's chat threads with document indicators and creation timestamps.
 * Includes "New Chat" functionality for creating empty threads.
 * 
 * Props:
 * - threads: Array of user's chat threads
 * - selectedId: Currently selected thread ID
 * - onSelect: Function to handle thread selection
 * - userData: Current user information
 * - onRefresh: Function to refresh thread list
 * - onCreateThread: Function to create new empty thread
 */

import React, { useState } from 'react';

export default function Sidebar({ threads, selectedId, onSelect, userData, onRefresh, onCreateThread, onUpdateThreadName }) {
   ...
   * Shows loading state during creation process
   */
   ...
   * Handles both ISO strings and MongoDB date objects
   */
  ...
  return (
    <div className="w-80 bg-gradient-to-b from-gray-900 to-gray-800 text-white flex flex-col h-full shadow-2xl">{/* Full height within container */}
      {/* Header */}
