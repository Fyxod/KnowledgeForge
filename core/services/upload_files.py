...
async def upload_files(files, user_id: str) -> List[dict]:
    """
    Asynchronously upload each file to the 'data/{user_id}/uploads' directory.
    ...
    """
    upload_dir = os.path.join("data", user_id, "uploads")
